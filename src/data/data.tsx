  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a Pitești, Romania based <strong className="text-stone-100">Site Reliability Engineer II</strong>, currently
        working at <strong className="text-stone-100">Microsoft</strong>. I specialize in ensuring the reliability and
        performance of Windows Autopatch and Windows Updates, making sure our users receive seamless and efficient
        experiences with their Windows devices.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        In my free time, you can find me playing <strong className="text-stone-100">video games</strong>, spending
        quality time with my <strong className="text-stone-100">family</strong>,{' '}
        <strong className="text-stone-100">reading</strong>, <strong className="text-stone-100">traveling </strong> to
        awesome places and watching <strong className="text-stone-100">movies</strong>.
      </p>
    </>
  ),
  actions: [
...
export const aboutData: About = {
  ...
  description: `I'm a Site Reliability Engineer with a passion for automating solutions and tackling technical challenges. My journey from Customer Support through Team Leadership to SRE has given me a unique perspective on technical excellence and user experience.
...
export const certifications: Certifications[] = [
  {
    ...
    verificationUrl:
      'https://learn.microsoft.com/en-us/users/razvannegrila-5065/credentials/certification/azure-ai-fundamentals?tab=credentials-tab',
  },
  {
    ...
    image: 'https://learn.microsoft.com/media/learn/certification/badges/microsoft-certified-fundamentals-badge.svg',
    verificationUrl:
      'https://learn.microsoft.com/en-us/users/razvannegrila-5065/credentials/certification/azure-fundamentals?tab=credentials-tab',
  },
];
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Provide expert technical support by analyzing complex customer incidents and developing innovative solutions to
        enhance system functionality. Mentor junior engineers, deliver educational sessions, and actively participate in
        initiatives like academic projects and conferences.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Analyzed customer-reported incidents, identified solutions within available resources, and optimized software
        performance. Engaged in professional development, collaborated with senior colleagues, and contributed to
  ...
  },
  {
    ...
    content: (
      <p>
        Ensured the implementation of Level 1 Permanent Controls for Global Technology Services. Managed access rights,
        updated control plans, conducted quality assurance on evaluations, and provided analytical support to
  ...
  },
  {
    ...
    content: (
      <p>
        Provided remote technical support to clients, resolving software and hardware issues and troubleshooting network
        problems. Assisted with ticket management, escalations, and collaborated with team members to deliver effective
        solutions.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Ensured efficient spare parts shipments and maintained high-quality customer service. Acted as the liaison
        between international clients and central warehouses in France. Managed sales administration tasks such as order
        placement, dispatch monitoring, invoicing, and customs operations. Utilized tools like Spotfire for analysis and
        reporting to optimize logistics flows and procedures.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Led a team of Client Advisors, overseeing project management and resource allocation. Prepared daily and monthly
        reports for clients, participated in conferences, and facilitated trainings and coaching sessions. Conducted
        recruitment assessments and implemented strategies to improve project results.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Assisted advisors in developing growth plans alongside team leaders. Supported team objectives through training,
        individual coaching, and qualitative analysis. Handled cases to enhance productivity across projects, providing
        ideas for procedural improvements and organizational efficiency.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Provided commercial assistance in online hotel reservations for customers worldwide via email and phone.
        Resolved inquiries and issues, ensuring customer satisfaction in the tourism sector.
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Offered technical and commercial support in the telecom field to French customers through email, chat, instant
        messaging, and calls. Addressed customer needs effectively, enhancing client engagement and service quality.
      </p>
    ),
...
export const contact: ContactSection = {
  ...
  description:
    'If you want to get in touch with me, just write me a message or reach out to me via one of the below channels.',
  items: [
    {
